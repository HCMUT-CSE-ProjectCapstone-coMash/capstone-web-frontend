...
export function Header() {
    ...
    return (
        <div className="bg-gray-white flex-col justify-content-center items-center px-6.25 font-display">
            <div className="flex px-3.75 h-24 items-center justify-between">
                ...
                <div className="flex justify-between items-center">
                    <div className="p-3"><BellIcon width={24} height={24}/></div>
                    <div className="bg-pink text-white flex justify-between items-center p-2.5 rounded-lg">
